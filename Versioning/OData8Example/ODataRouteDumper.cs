...
{
    /// <summary>
    /// Ripped from https://github.com/OData/AspNetCoreOData/blob/master/sample/ODataRoutingSample/Extensions/ODataRouteHandler.cs
    /// </summary>
    public static class ODataRouteDumper
    {
        /// <summary>
        ...
        public static async Task DumpAllODataRoutes(HttpContext context)
        {
